...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<table border="1" class="table">
		...
		$query_mysql = mysqli_query($host,"SELECT * FROM siswa")or die(mysql_error());
		$nomor = 1; 
		...
		<tr>
			...
			<td><?php echo $data['nim']; ?></td> <!--variabel nim-->
			<td><?php echo $data['nama']; ?></td> <!--variabel nama-->
			<td><?php echo $data['kelas']; ?></td> <!--variabel kelas-->
			<td><?php echo $data['alamat']; ?></td> <!--variabel alamat-->
			<td><?php echo $data['jk']; ?></td> <!--variabel jk-->
		</tr>
		<?php } ?>
	</table>
        </div>
